...
class VocabEntry(object):
    def __init__(self):
        self.word2id = dict()
        self.unk_id = 1
        self.word2id[constants.PAD_WORD] = 0
        self.word2id[constants.UNK_WORD] = 1
        self.word2id[constants.BOS_WORD] = 2
        self.word2id[constants.EOS_WORD] = 3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_vocab_size', default=1000, type=int, help='source vocabulary size')
    parser.add_argument('--tgt_vocab_size', default=1000, type=int, help='target vocabulary size')
    ...
    parser.add_argument('--train_src', default='./2000sents/train.ch', type=str, help='file of source sentences')
    parser.add_argument('--train_tgt', default='./2000sents/train.en', type=str, help='file of target sentences')

    parser.add_argument('--output', default='./2000sents/vocab.bin', type=str, help='output vocabulary file')
